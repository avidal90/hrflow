...
La decision canonica actual sobre identidad y perfil laboral esta definida en knowledge/user-as-employee-refactor.md. Cualquier referencia existente al modelo dual User + Employee debe considerarse transitoria hasta completar el refactor.
