...
<x-layouts.portal :title="$title . ' | Portal HRFlow'">
    ...
    <div class="rounded-2xl border border-dashed border-slate-300 bg-white p-12 text-center">
        ...
        <h2 class="mt-4 text-lg font-semibold text-slate-900">Modulo en desarrollo</h2>
        <p class="mx-auto mt-2 max-w-sm text-sm leading-6 text-slate-600">
            La estructura base esta lista. Los flujos operativos se implementaran en las siguientes fases.
        </p>
        <a href="{{ route('portal.dashboard', $tenantRouteParameters) }}" class="mt-6 inline-flex items-center gap-1.5 rounded-xl bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-slate-800">
            Volver al dashboard
        </a>
    </div>
</x-layouts.portal>